...
export function CameraRig({resetKey,inspection=false,distance=9.2,catalog=false,target=BODY_TARGET}:{resetKey:number;inspection?:boolean;distance?:number;catalog?:boolean;target?:Vec3}) {
  ...
  useEffect(()=>{
    ...
    moving.current=true;
    invalidate();
  },[distance,resetKey,inspection,invalidate,targetVector,camera]);
